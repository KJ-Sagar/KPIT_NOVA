...
void rc_emulation_initialize(void)
{
  ...
  /* External mode info */
  rc_emulation_M->Sizes.checksums[0] = (3807635540U);
  rc_emulation_M->Sizes.checksums[1] = (3862757015U);
  rc_emulation_M->Sizes.checksums[2] = (1373803603U);
  rc_emulation_M->Sizes.checksums[3] = (363877343U);
  ...
  rc_emulation_DW.obj_p.matlabCodegenIsDeleted = false;
  rc_emulation_DW.obj_p.isInitialized = 1L;
  digitalIOSetup(9, 1);
  rc_emulation_DW.obj_p.isSetupComplete = true;
...
void rc_emulation_terminate(void)
{
  ...
  if (!rc_emulation_DW.obj_p.matlabCodegenIsDeleted) {
    rc_emulation_DW.obj_p.matlabCodegenIsDeleted = true;
  }
