###########################################################################
## Makefile generated for component 'blinkingled1'. 
## 
## Makefile     : blinkingled1.mk
## Generated on : Wed Feb 19 14:19:58 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/blinkingled1.elf
...
PRODUCT_NAME              = blinkingled1
MAKEFILE                  = blinkingled1.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2024b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2024b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/chall/OneDrive/Desktop/MBD_KPIT/KPIT_TRAINING/Marathon_2
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH                 = C:/Users/chall/DOCUME~1/MATLAB/R2024b/ARDUIN~1/ARDUIN~1/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/blinkingled1.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=1 -DMW_PRESCALAR=1024 -DMW_TIMERCOUNT=49911 -DMW_SCHEDULERCOUNTER=1 -DARDUINO_NUM_SERIAL_PORTS=1 -DARDUINO_SERIAL_RECEIVE_BUFFER_SIZE=64 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_CONFIG_SERIAL0_=SERIAL_8N1 -D_RTT_ANALOG_REF_=0 -DMW_NUM_PINS=20 -D_ONBOARD_EEPROM_SIZE_=1024
...
DEFINES_STANDARD = -DMODEL=blinkingled1 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o blinkingled1.o blinkingled1_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/blinkingled1_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/blinkingled1_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/blinkingled1_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
blinkingled1.o : $(START_DIR)/blinkingled1_ert_rtw/blinkingled1.c
	$(CC) $(CFLAGS) -o "$@" "$<"


blinkingled1_data.o : $(START_DIR)/blinkingled1_ert_rtw/blinkingled1_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/blinkingled1_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
